...
2019-01-17 V1.0.9：
	...
	2、针对pjax评论作了修整，目前已支持评论，但不支持多次评论，可间断评论；
	3、针对音乐播放器增加后台设置歌单等设置，方便设置。

2018-12-29 V1.0.8：

	1、由自己实现的评论转变为系统自带的评论，使用CommentToMail插件支持了评论通知，并进化为侧滑评论显示；
	2、修复pjax从内页到首页加载不完的情况，但主题设置那3个开关依然没有完善；
	3、补充头部和底部增加内置js函数；
	4、修改侧边栏数据获取的方法；
	5、取消config配置文件；
	6、修复一小部分bug，如果网站有CDN更新时需要更新style.css的缓存和浏览器缓存；
	7、期待后续更新……
