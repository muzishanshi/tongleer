  ...
  <div class="am-u-md-9 am-u-md-push-3">
    ...
    <section class="am-u-md-12">
	  <?php if ($this->have()): ?>
		<ul class="am-list">
		  ...
		  <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left" style="background-color:#fff;margin-bottom:10px;">
			...
			<ul class="am-avg-sm-2" style="text-align:center;">
			  ...
			  <li style="border-top:1px solid #ddd;"><a class="am-list-item-text" href="">评论 <?php $this->commentsNum('0', '1', '%d'); ?></a></li>
			  <script>
		...
		<?php $this->pageNav('«', '»', 3, '...', array('wrapTag' => 'ul', 'wrapClass' => 'am-pagination am-pagination-right', 'itemTag' => 'li', 'textTag' => 'a', 'currentClass' => 'am-active', 'prevClass' => '', 'nextClass' => '')); ?>
	  <?php else: ?>
		<style>
		.page-main{
